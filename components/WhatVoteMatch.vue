<template>
  <el-dialog
    ...
    <h2>回答内容の記録について</h2>
    <p>
      本サービスでは、利用者の回答内容を集計のため記録しています。IPアドレス等の個人情報と紐付けて記録・保持することは一切ありませんが、回答結果は動向分析、情報発信等に使用させていただく場合がございます。予めご了承の上サービスをご利用ください。</p>
    <p>その他、NPO法人メディアージのWebサイトに関するプライバシーポリシーは下記を参照ください。</p>
    <p><a href="http://mediage.org/privacy-policy">http://mediage.org/privacy-policy</a></p>
