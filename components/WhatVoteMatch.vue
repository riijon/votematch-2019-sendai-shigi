<template>
  <el-dialog
    ...
    <p>有権者（あなた）と候補者の双方に同内容のアンケートに答えてもらい、政策についての考えのマッチ率（一致度）を測定することができるインターネットサービスです。<br>
      （参照： Wikipedia）</p>
    ...
    <p>最初に選挙区を選んでください。この回答はマッチ率には影響しませんが、最後にマッチ率が表示される候補者は、選んだ選挙区から出馬している方になります。</p>

    <p>それぞれの問いについて、該当する答えを選択肢から選んでください。</p>
    <p>Q1は、広くあなたの政治指向や信条に関する設問、Q2は、仙台市政に関わるやや具体的な設問となっています。Q2については、設問に対する補足説明も用意しております。</p>
    ...
    <p>最後の問いのみ、複数の選択肢を選ぶことができます。チェックボックスを3つチェックしてください。チェックが３つ以下でも測定結果を見ることはできますが、立候補者とのマッチ率は下がる場合があります。</p>
    ...
    <p>あなたと候補者が同じ回答をした回答について、「マッチした」とみなします。</p>
